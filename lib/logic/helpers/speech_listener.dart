...
//     debugPrint("faaz: $path, $appDirectory");
//   }

//   SpeechToText speech = SpeechToText();

//   Future<void> onResultHandler(String val) async {
//     speechBloc.add(ConcatenateSpeech(speech: val));
//     if (kDebugMode) {
//       print("faaz: ${val}");
//     }
//     await stopListening();
...
//     onResultHandler("Sample text added");
//     stopRecording();
